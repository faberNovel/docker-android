...
| librsvg2-2:amd64 | 2.48.9-1ubuntu0.20.04.4 | amd64 | SAX-based renderer library for SVG files (runtime) |
...
| python-pip-whl | 20.0.2-5ubuntu1.10 | all | Python package installer |
