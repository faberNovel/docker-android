...
| git | 1:2.25.1-1ubuntu3.1 | amd64 | fast, scalable, distributed revision control system |
...
| libpython3.8:amd64 | 3.8.5-1~20.04.3 | amd64 | Shared Python runtime library (version 3.8) |
| libpython3.8-dev:amd64 | 3.8.5-1~20.04.3 | amd64 | Header files and a static library for Python (v3.8) |
| libpython3.8-minimal:amd64 | 3.8.5-1~20.04.3 | amd64 | Minimal subset of the Python language (version 3.8) |
| libpython3.8-stdlib:amd64 | 3.8.5-1~20.04.3 | amd64 | Interactive high-level object-oriented language (standard library, version 3.8) |
...
| openssh-sftp-server | 1:8.2p1-4ubuntu0.2 | amd64 | secure shell (SSH) sftp server module, for SFTP access from remote machines |
...
| python-pip-whl | 20.0.2-5ubuntu1.5 | all | Python package installer |
...
| python3-pip | 20.0.2-5ubuntu1.5 | all | Python package installer |
...
| python3.8 | 3.8.5-1~20.04.3 | amd64 | Interactive high-level object-oriented language (version 3.8) |
| python3.8-dev | 3.8.5-1~20.04.3 | amd64 | Header files and a static library for Python (v3.8) |
| python3.8-minimal | 3.8.5-1~20.04.3 | amd64 | Minimal subset of the Python language (version 3.8) |
