...
| libc-dev-bin | 2.31-0ubuntu9.1 | amd64 | GNU C Library: Development binaries |
...
| libpython3.8:amd64 | 3.8.5-1~20.04 | amd64 | Shared Python runtime library (version 3.8) |
| libpython3.8-dev:amd64 | 3.8.5-1~20.04 | amd64 | Header files and a static library for Python (v3.8) |
| libpython3.8-minimal:amd64 | 3.8.5-1~20.04 | amd64 | Minimal subset of the Python language (version 3.8) |
| libpython3.8-stdlib:amd64 | 3.8.5-1~20.04 | amd64 | Interactive high-level object-oriented language (standard library, version 3.8) |
...
| python-pip-whl | 20.0.2-5ubuntu1.1 | all | Python package installer |
...
| python3-distutils | 3.8.5-1~20.04.1 | all | distutils package for Python 3.x |
| python3-lib2to3 | 3.8.5-1~20.04.1 | all | Interactive high-level object-oriented language (lib2to3) |
| python3-minimal | 3.8.2-0ubuntu2 | amd64 | minimal subset of the Python language (default python3 version) |
| python3-pip | 20.0.2-5ubuntu1.1 | all | Python package installer |
...
| python3.8 | 3.8.5-1~20.04 | amd64 | Interactive high-level object-oriented language (version 3.8) |
| python3.8-dev | 3.8.5-1~20.04 | amd64 | Header files and a static library for Python (v3.8) |
| python3.8-minimal | 3.8.5-1~20.04 | amd64 | Minimal subset of the Python language (version 3.8) |
