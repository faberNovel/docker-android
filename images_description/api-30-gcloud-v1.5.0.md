...
| cpp-9 | 9.4.0-1ubuntu1~20.04 | amd64 | GNU C preprocessor |
...
| g++-9 | 9.4.0-1ubuntu1~20.04 | amd64 | GNU C++ compiler |
...
| gcc-9 | 9.4.0-1ubuntu1~20.04 | amd64 | GNU C compiler |
| gcc-9-base:amd64 | 9.4.0-1ubuntu1~20.04 | amd64 | GCC, the GNU Compiler Collection (base package) |
...
| libasan5:amd64 | 9.4.0-1ubuntu1~20.04 | amd64 | AddressSanitizer -- a fast memory error detector |
...
| libcurl4:amd64 | 7.68.0-1ubuntu2.7 | amd64 | easy-to-use client-side URL transfer library (OpenSSL flavour) |
| libcurl4-openssl-dev:amd64 | 7.68.0-1ubuntu2.7 | amd64 | development files and documentation for libcurl (OpenSSL flavour) |
...
| libexpat1-dev:amd64 | 2.2.9-1ubuntu0.4 | amd64 | XML parsing C library - development kit |
...
| libgcc-9-dev:amd64 | 9.4.0-1ubuntu1~20.04 | amd64 | GCC support library (development files) |
...
| libpython3.8:amd64 | 3.8.10-0ubuntu1~20.04.2 | amd64 | Shared Python runtime library (version 3.8) |
| libpython3.8-dev:amd64 | 3.8.10-0ubuntu1~20.04.2 | amd64 | Header files and a static library for Python (v3.8) |
...
| libssl-dev:amd64 | 1.1.1f-1ubuntu2.11 | amd64 | Secure Sockets Layer toolkit - development files |
| libssl1.1:amd64 | 1.1.1f-1ubuntu2.11 | amd64 | Secure Sockets Layer toolkit - shared libraries |
| libstdc++-9-dev:amd64 | 9.4.0-1ubuntu1~20.04 | amd64 | GNU Standard C++ Library v3 (development files) |
| libstdc++6:amd64 | 10.3.0-1ubuntu1~20.04 | amd64 | GNU Standard C++ Library v3 |
| libsystemd0:amd64 | 245.4-4ubuntu3.15 | amd64 | systemd utility library |
...
| libudev1:amd64 | 245.4-4ubuntu3.15 | amd64 | libudev shared library |
...
| linux-libc-dev:amd64 | 5.4.0-104.118 | amd64 | Linux Kernel Headers for development |
...
| openjdk-11-jdk:amd64 | 11.0.14+9-0ubuntu2~20.04 | amd64 | OpenJDK Development Kit (JDK) |
| openjdk-11-jdk-headless:amd64 | 11.0.14+9-0ubuntu2~20.04 | amd64 | OpenJDK Development Kit (JDK) (headless) |
| openjdk-11-jre:amd64 | 11.0.14+9-0ubuntu2~20.04 | amd64 | OpenJDK Java runtime, using Hotspot JIT |
| openjdk-11-jre-headless:amd64 | 11.0.14+9-0ubuntu2~20.04 | amd64 | OpenJDK Java runtime, using Hotspot JIT (headless) |
...
| openssl | 1.1.1f-1ubuntu2.11 | amd64 | Secure Sockets Layer toolkit - cryptographic utility |
...
| python-pip-whl | 20.0.2-5ubuntu1.6 | all | Python package installer |
...
| python3-pip | 20.0.2-5ubuntu1.6 | all | Python package installer |
...
| python3.8-dev | 3.8.10-0ubuntu1~20.04.2 | amd64 | Header files and a static library for Python (v3.8) |
